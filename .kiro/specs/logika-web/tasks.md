...
- [ ] 1. Project setup and configuration
  ...
  - [ ] 1.2 Set up Firebase Admin SDK and environment variables
    ...
    - Ensure no `NEXT_PUBLIC_` prefix — all credentials are server-side only
    - _Requirements: 12.1, 14.2_

  - [ ] 1.3 Create TypeScript types and constants
  ...
  - [ ] 1.4 Implement Firestore data access layer
  ...
  - [ ] 1.5 Install testing dependencies and configure Jest
